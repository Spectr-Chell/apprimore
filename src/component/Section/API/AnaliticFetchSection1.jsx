...
const data = require('../../../data/AppleData.json')


export default function AnaliticFetchSection1() { 
    ...
    return ( 
        ...
        > 
            <h1>Новости Apple</h1>
            {/* <h2 style={{position: 'absolute', left: '80px'}}>всего статей: {data.totalResults}</h2> */}
